 ...
 *
 * Satisfies just the Horde_Session subset the Kolab_Session storage
 * driver calls (get / set). Avoids the legacy shim's full bootstrap
 ...
 */
class Horde_Kolab_Session_Test_Session
{
